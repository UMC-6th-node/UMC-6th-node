...
export const status = {
    ...
    EMAIL_ALREADY_EXIST: {status: StatusCodes.BAD_REQUEST, "isSuccess": false, "code": "COMMON006", "message": "이미 존재하는 이메일입니다." },
    PARAMETER_IS_WRONG: {status: StatusCodes.BAD_REQUEST, "isSuccess": false, "code": "COMMON007", "message": "요청 파라미터가 다릅니다." },
};